...
class DataBase {
    ...
    var getPath = { () -> String in
        ...
        return docsDir.appendingPathComponent("musicsLinggka001.db")
    }
    ...
    var insertData = { (_ controller: DataBase, _ path: String) in
        ...
        //Song
        controller.insertDatabase("SONGS", ["SongName":"Em Gái Mưa - Linh Ka Cover", "UrlImg":"3.jpg"], path)
        controller.insertDatabase("SONGS", ["SongName":"Chưa bao giờ mẹ kể - Linh Ka Cover", "UrlImg":"4.jpg"], path)
        controller.insertDatabase("SONGS", ["SongName":"Từ hôm nay - Linh Ka Cover", "UrlImg":"5.jpg"], path)
        controller.insertDatabase("SONGS", ["SongName":"Đẹp nhất là em - Linh Ka, Long Hoang", "UrlImg":"6.jpg"], path)
        controller.insertDatabase("SONGS", ["SongName":"Ánh nắng của em - Linh Ka Cover", "UrlImg":"7.jpg"], path)
        controller.insertDatabase("SONGS", ["SongName":"Nơi này có em - Linh Ka Cover", "UrlImg":"8.jpg"], path)
        controller.insertDatabase("SONGS", ["SongName":"Muốn yêu ai đó cả cuộc đời - Linh Ka Cover", "UrlImg":"9.jpg"], path)
        controller.insertDatabase("SONGS", ["SongName":"Có em chờ - Linh Ka Cover", "UrlImg":"10.jpg"], path)
        controller.insertDatabase("SONGS", ["SongName":"Hong kong 1 - Linh Ka Cover", "UrlImg":"11.jpg"], path)
        controller.insertDatabase("SONGS", ["SongName":"Cho anh hỏi - Linh Ka Cover", "UrlImg":"12.jpg"], path)
